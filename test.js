const _0x5e8e = [
    ...
    'split',
    '\x20Game\x20Build:',
    'Äas\x20poslania\x20nesmie\x20byĹĽ\x20prĂĄzdny!',
...
var translations = {
    ...
    sk_SK: {
        ...
        Help: _0x640e('0x40'),
        'Script\x20must\x20be\x20executed\x20from\x20a\x20Command\x20Confirm\x20screen!':
            'Skript\x20musĂ­\x20byĹĽ\x20spustenĂ˝\x20z\x20potvrdzovacej\x20obrazovky\x20prĂ­kazu!',
        ...
        'Start\x20Timer': 'SpustiĹĽ\x20ÄasovaÄ',
    },
};
initDebug();
function addTimerUI() {
...
function initDebug() {
    console[_0x640e('0x16')](scriptInfo() + '\x20It\x20works\x20đ!');
